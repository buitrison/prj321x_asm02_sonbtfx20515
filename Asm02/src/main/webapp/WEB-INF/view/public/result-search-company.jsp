								...
								<div class="col-md-12 nav-link-wrap">
									<div class="nav nav-pills text-center" id="v-pills-tab"
										...
										<a class="nav-link" id="v-pills-1-tab" data-toggle="pill"
											...
											aria-selected="false">Tìm công việc</a> <a
											class="nav-link active mr-md-1" id="v-pills-2-tab"
											data-toggle="pill" href="#v-pills-2" role="tab"
											aria-controls="v-pills-2" aria-selected="true">Tìm theo
	...
	<section class="ftco-section bg-light">
		<div class="container">
			<h4 style="margin-top: -20px">
				Kết quả tìm kiếm công ty: <span>${param.keySearch}</span>
			</h4>
			<div class="row">
